...
use crate::data::audio_recording::{AudioRecorder, AudioSession, ThinkAloudAnalyzer};
use crate::compliance::irb::{IRBComplianceGenerator, StudySummary};
use crate::statistics::mixed_effects::{MixedEffectsAnalyzer, MixedEffectsData};
use crate::statistics::power_analysis::{PowerAnalyzer, StatisticalTestType};
use crate::compliance::preregistration::{
    AnalysisValidator, PowerAnalysisSpec, PreRegistration, RegistrationStatus, StudyMetadata,
    TransparencyReport,
};
use crate::data::sensor_integration::{

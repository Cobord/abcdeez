    ...
    fn create_initial_commit(&mut self, repo_id: &str) -> Result<(), String> {
        ...
        let initial_experiment = MultiSessionExperiment {
            ...
            design: ExperimentalDesign::BetweenSubjects {
                ...
                randomization: crate::experiments::design::RandomizationType::Simple,
            },
            sessions: Vec::new(),
            participant_assignments: HashMap::new(),
            scheduling_rules: crate::experiments::multi_session::SchedulingRules {
                allow_overlap: false,
                max_concurrent_participants: None,
                preferred_time_windows: Vec::new(),
                blocked_dates: Vec::new(),
                reminder_settings: crate::experiments::multi_session::ReminderSettings {
                    enabled: false,
                    advance_hours: Vec::new(),
                    method: Vec::new(),
                },
                rescheduling_policy: crate::experiments::multi_session::ReschedulingPolicy {
                    max_reschedules_per_session: 0,
                    automatic_reschedule_window_hours: 24,
                    penalty_for_no_show: None,
                },
            },
            data_retention_policy: crate::experiments::multi_session::DataRetentionPolicy::default(),
            analysis_plan: crate::experiments::multi_session::AnalysisPlan::default(),
            status: crate::experiments::multi_session::ExperimentStatus::Planning,
            created_at: chrono::Utc::now(),
            last_modified: chrono::Utc::now(),
        };

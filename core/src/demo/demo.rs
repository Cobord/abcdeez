...
pub fn demonstrate_eig() {
    ...
    let learner_model = crate::learning::learner::LearnerModel::new("eig_demo".to_string(), &topology);
    let mut scheduler =
        crate::learning::adaptive::AdaptiveScheduler::new_with_eig(learner_model, topology.clone(), true);
    ...
    let learner_model2 = crate::learning::learner::LearnerModel::new("random".to_string(), &topology);
    let mut scheduler2 =
        crate::learning::adaptive::AdaptiveScheduler::new_with_eig(learner_model2, topology.clone(), false);

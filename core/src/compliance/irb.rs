use super::citation_manager::CitationManager;
...
impl IRBComplianceGenerator {
    ...
    fn generate_subject_selection(
        ...
        Ok(SubjectSelection {
            inclusion_criteria: vec![
                ...
                "Available for multiple study sessions".to_string(),
    ...
    fn identify_supporting_documents(
        ...
        documents.push(SupportingDocument {
            ...
            file_path: None,
            description: "Electronic consent form for study participation".to_string(),
        });

-- PostgreSQL Migration: Gamification System
...
-- Initialize default daily challenges
INSERT INTO daily_challenges (id, challenge_date, challenge_type, requirements, reward_xp, reward_points)
VALUES 
    (gen_random_uuid(), CURRENT_DATE, 'accuracy_master', '{"min_accuracy": 0.9, "min_tasks": 20}', 100, 20),
    (gen_random_uuid(), CURRENT_DATE, 'speed_demon', '{"max_avg_time_ms": 2000, "min_tasks": 15}', 75, 15),
    (gen_random_uuid(), CURRENT_DATE, 'consistent_practice', '{"min_tasks": 50}', 50, 10)

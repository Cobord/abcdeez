...
use abcdeez_core::{
    AdaptiveScheduler, HintLevel, InterventionSystem, LearnerMetrics,
    StruggleLevel, TaskGenerator, TaskSession, Topology,
};
...
use crate::{
    ...
    demo::DemoController,
    easter_egg::LittleCrab,
    models,
    models::*,
    research,
    services::{federation, AdaptiveApiClient, ApiClientTrait, ConnectivityMonitor, OfflineStorage, OfflineSyncStatus as SyncStatus},
    Screen,
};
...
pub struct AppData {
    ...
    #[cfg(target_os = "ios")]
    pub ios_auth_bridge: Option<crate::ios_auth::IOSAuthBridge>,
    ...
    pub protocol_versions: Vec<models::ProtocolVersion>,
    pub current_protocol_version: Option<String>,
    pub selected_protocol_version: Option<String>,
    pub protocol_version_diff: Option<models::ProtocolVersionDiff>,
...
impl Default for AppData {
    fn default() -> Self {
        ...
        Self {
            ...
            demo_speed: 1.0,
            preferred_demo: "comprehensive".to_string(),
            ...
            api_timeout_input: String::new(),
            api_fallback_enabled: true,
            show_api_settings: false,
            api_connection_status: "Checking...".to_string(),
            ...
            // Protocol Editor Form State
            protocol_editor_name: String::new(),
            protocol_editor_description: String::new(),
            protocol_editor_design_type: "between_subjects".to_string(),
            protocol_editor_target_n: "30".to_string(),
            protocol_editor_power: "0.8".to_string(),
            protocol_editor_effect_size: "0.5".to_string(),
            protocol_editor_alpha: "0.05".to_string(),
            protocol_editor_duration_weeks: "4".to_string(),
            protocol_editor_sessions_per_participant: "10".to_string(),
            protocol_editor_data_retention_years: "7".to_string(),
            protocol_editor_version_message: String::new(),

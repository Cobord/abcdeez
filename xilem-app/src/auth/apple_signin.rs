...
use crate::components::{AppComponents, Component, ComponentOutput};
...
pub fn standard_apple_signin_button<C: AppComponents>(state: &AppState) -> C::Output {
    apple_signin_button::<C>(
        state,
...
pub fn continue_with_apple_button<C: AppComponents>(state: &AppState) -> C::Output {
    apple_signin_button::<C>(
        state,
...
pub fn github_signin_button<C: AppComponents>(state: &AppState) -> C::Output {
    let button_text = if state.oauth_login_in_flight {
